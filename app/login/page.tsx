  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden'>
      ...
      <div className='w-full max-w-md relative z-10'>
        <Card className='glass-effect border-slate-700/50 shadow-2xl animate-fade-in-scale'>
          ...
          <CardContent className='space-y-6'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
              ...
              <div className='pt-2 animate-fade-in-scale' style={{ animationDelay: '300ms' }}>
                <Button
                  type='submit'
                  disabled={loading}
            ...
            <div className='relative animate-slide-in-bottom' style={{ animationDelay: '400ms' }}>
              <div className='absolute inset-0 flex items-center'>
                <span className='w-full border-t border-slate-600' />
              </div>
              <div className='relative flex justify-center text-xs uppercase'>
                <span className='bg-slate-800 px-2 text-slate-400'>Don't have an account?</span>
              </div>
            </div>
        ...
        >
          <p className='text-sm text-slate-400'>Secure, private, and always under your control</p>
        </div>
      </div>
    </div>
  );
