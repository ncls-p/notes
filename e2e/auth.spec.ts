...
test.describe("Authentication E2E Tests", () => {
  ...
  test.describe("User Login", () => {
    ...
    test("should have working navigation to register page", async ({
      page,
    }) => {
      await page.goto("/login");
  ...
  test.describe("Protected Routes", () => {
    ...
    test("should redirect unauthenticated users from notes page", async ({
      page,
    }) => {
  ...
  test.describe("User Flow Integration", () => {
    ...
    test("should handle browser back/forward after authentication", async ({
      page,
    }) => {
      // Login
      await page.goto("/login");
